...
void reflattenImage(unwrapPhaseImage *inputImage, paramData params)
{
    ...
    */
    if (params.nBaselines == 3)
    { /* Dual baselines */
        Bn = params.Bn1 + params.Bn2;
        Bp = params.Bp1 + params.Bp2;
    ...
    */
    ...
    for (i = 0; i < inputImage->azimuthSize; i++)
    {
        ...
        */
        ...
        {
            if (inputImage->phase[i][j] > (-LARGEINT / 10))
            { /*unwrapped values*/
                ...
                */
                ...
                inputImage->phase[i][j] = -LARGEINT; /* end if */
            r0 += dr;
        } /* End for j */
        phiAzimuth += dPhi;
