...
void inputParamFile(char *paramFile, paramData *params)
{
    ...
    double dum;
    double lambda;
    int32_t nlr, nla, nBaselines, nPar;
    ...
    */
    ...
    fprintf(stderr,
            "\n Bn1 %f \n Bp1 %f \n dBn1 %f \n Bn2 %f \n Bp2 %f \n dBn2 %f \n BnEst %f\n BpEst %f \n dBnEst %f \n omegaA %f  \n dBnQ %f \n dBpQ %f\n\n", params->Bn1, params->Bp1, params->dBn1, params->Bn2, params->Bp2, params->dBn2, params->BnEst, params->BpEst, params->dBnEst, params->omegaA, params->dBnEstQ, params->dBpEstQ);
}
