...
static void readArgs(int argc,char *argv[], int *nr, int *na, char **imageFile,double *minValue,  int *interpLength, int *padEdges, int *intType, 
		     int *thresh,float *ratThresh,int *fastFlag,     int *allowBreaks, int *islandThresh, int *islandAreaThresh);
static void usage();
...
{   
	...
	int thresh, islandThresh, islandAreaThresh;
	int nr,na;
	int i,j;                               /* LCV */
	/* 
...
static void readArgs(int argc,char *argv[], int *nr, int *na,  char **imageFile,double *minValue,
		     int *interpLength,int *padEdges, int *intType, int *thresh,float *ratThresh, int *fastFlag, int *allowBreaks,
		     int *islandThresh, int *islandAreaThresh)
{
	int filenameArg;
	char *argString;
	int i,n;
