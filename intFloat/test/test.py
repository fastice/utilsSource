...
call('intfloat -interpLength 12 -nr 200 -na 200 test.orig > test.interp', shell=True, executable='/bin/csh')

result = readImage('test.interp', 200, 200, '>f4')
correct = readImage('test.true', 200, 200, '>f4')

print(f'Result mean diff {np.mean(result-correct)}  {np.std(result-correct)} ')
